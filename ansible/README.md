...
**What it costs:** two small containers (~50MB RAM) on your server. No ports opened, no inbound connections. Metrics are pushed outbound only.
...
```
Your Server (2 containers added)        Central Server (operated by inc4)
┌─────────────────────────────┐         ┌──────────────────────────────┐
│                             │         │                              │
